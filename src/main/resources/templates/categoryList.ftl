                ...
                <div class="card-body">
                    <form method="post" action="/category/admin/create">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="titleEn" class="form-control" placeholder="Title En" aria-label="Title En" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">Title Ru</span>
                            </div>
                            <input type="text" name="titleRu" class="form-control" placeholder="Title Ru" aria-label="Title Ru" aria-describedby="basic-addon1">
                        </div>
